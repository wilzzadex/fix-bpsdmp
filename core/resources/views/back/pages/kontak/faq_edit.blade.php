        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="{{ route('admin.faq.update',$faq->id) }}" method="POST" enctype="multipart/form-data" id="form-faq">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="tabbable">
                                            ...
                                            <p>
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="text" value="{{ $faq->pertanyaan_id }}" placeholder="pertanyaan" name="pertanyaan_id" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <label for="">Jawaban</label>
                                                        <textarea class="ckeditor form-control" name="jawaban_id" cols="30" rows="10">{{ $faq->jawaban_id }}</textarea>
                                                    </div>
                                                </div>
                                            </p>
                                        </div>
                                        ...
                                        <p>
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="text" value="{{ $faq->pertanyaan_en }}" name="pertanyaan_en" placeholder="Question" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <label for="">Answer</label>
                                                        <textarea class="ckeditor form-control" name="jawaban_en" cols="30" rows="10">{{ $faq->jawaban_en }}</textarea>
                                                    </div>
                                                </div>
                                            </p>
                                        </div>

        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{ route('admin.galeri.video.store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal" id="form-video">
                    {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="tabbable">
                                            ...
                                            <p>
                                                <div class="form-group">
                                                    <div class="col-sm-12 validate">
                                                        ...
                                                        <input type="text" placeholder="Judul" name="judul_id" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-sm-12 validate">
                                                        <label for="">Deskripsi</label>
                                                        <textarea name="deskripsi_id" class="ckeditor form-control" cols="30" rows="10"></textarea>
                                                    </div>
                                                </div>
                                            </p>
                                        </div>
                                            ...
                                            <p>
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="text" name="judul_en" placeholder=" Title" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <label for="">Description</label>
                                                        <textarea name="deskripsi_en" class="ckeditor form-control" cols="30" rows="10"></textarea>
                                                    </div>
                                                </div>
                                            </p>
                                        </div>
                                ...
                                <div class="form-group validate" id="elemen" style="margin-left:10px; margin-right:10px;">
                                    ...
                                    <input type="url" placeholder="Url Youtube" name="url_video" class="form-control">

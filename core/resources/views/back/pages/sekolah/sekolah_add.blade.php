        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{ route('admin.sekolah.store') }}" method="POST" enctype="multipart/form-data" id="form-sekolah">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="form-group validate">
                                        ...
                                        <input type="text"  name="singkatan" placeholder="Singkatan ..." class="form-control" style="text-transform: uppercase">
                                    </div>
                                    <div class="form-group validate">
                                        ...
                                        <select name="id_matra" required class="form-control">
                                            ...
                                            @foreach ($matra as $matra)
                                                <option value="{{ $matra->id }}">{{ $matra->nama }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group validate">
                                    ...
                                    <div class="form-group validate">
                                        ...
                                        <input type="text" name="no_tlp" placeholder="No Telp ..." class="form-control">
                                    </div>
                                    <div class="form-group validate">

                                        <label for="">Website</label>
                                        <input type="url" name="url" placeholder="Website ..." class="form-control">
                                    </div>
                                    <div class="form-group validate">
                                    ...
                                    <div class="form-group validate">
                                        ...
                                        <label class="btn btn-raised btn-default btn-sm"
                                            style="color: white; width: 180px; background: grey; height: 30px;">
                                            <i class="fa fa-picture-o"></i> Pilih Logo<input type="file"
                                                name="logo" accept="image/*" style="opacity: 0;"
                                                onchange="hasillogo(this)" required></label>
                                        <span class="label-logo" style="margin-left: 2%;"> Belum Ada
                                            Logo</span>
                                        <br>
                                        <br>
                                        <br>
...
<script>
    ...
    function addGambar() {
        $('#gambar').append(`
                <tr id="img_`+ img_id + `">
                <td class="validate"><input type="text" name="judul_foto_id[]" required placeholder="Judul ..." class="form-control"></td>
    ...
    function hasillogo(obj) {
        ...
        if (obj.files && obj.files[0] && (ext == "png" || ext == "jpeg" || ext == "jpg")) {
            if(obj.files[0].size > 5242880){
                ...
                $('.label-logo').html('Belum ada logo');
                $("#inputFile").val('');
            }else{
                var reader = new FileReader();
                reader.onload = function (e) {
            ...
            $(obj).val('');
            $('.label-logo').text('Belum ada gambar.');
        }
    }

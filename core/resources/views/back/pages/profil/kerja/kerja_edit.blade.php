        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="form-kerja_sama" action="{{ route('admin.kerja.update',$kerja_sama->id) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-12">                 
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 validate">
                                            <input type="text" value="{{ $kerja_sama->nomor }}" name="nomor" class="form-control" id="" placeholder="Nomor ...">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">
                                        ...
                                        <div class="col-sm-9 validate">
                                            <div class="input-group">
                                                <input placeholder="Tanggal ..." value="{{ date('d M Y',strtotime($kerja_sama->tanggal_kerjasama)) }}" type="text" name="tanggal" id="tanggal" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 validate">
                                            <textarea class="form-control" cols="10" name="uraian" rows="3">{{ $kerja_sama->uraian }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">
                                        ...
                                        <div class="col-sm-9 validate">
                                            <input type="text" value="{{ $kerja_sama->uraian }}" name="institusi" class="form-control" id="" placeholder="Institusi ...">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">
                                        ...
                                        <div class="col-sm-9 validate">
                                            ...
                                            <span class="label-gmbr" style="margin-left: 2%;"> {{ $kerja_sama->file }}</span> 
                                        </div>
                                    </div>
                                    <br>
                                    <br>
...
@section('custom-script')
    ...
    <script>
        ...
        function hasilgmbr(obj) {
            ...
            if (obj.files && obj.files[0] && (ext == "pdf" || ext == "png" || ext == "jpeg" || ext == "jpg")) {
                if(obj.files[0].size > 5242880){
                    ...
                    $('.label-gmbr').html('{{ $kerja_sama->file }}');
                    $("#inputFile").val('');
                }else{
                ...
                $(obj).val('');
                $('.label-gmbr').text('{{ $kerja_sama->file }}');
            }
        }

    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    Edit Regulasi & Kebijakan
                </li>

            </ol>
            <div class="page-header">
                <h1>Edit Regulasi & Kebijakan</h1>
            </div>
        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{ route('admin.regulasi.update',$regulasi->id) }}" id="form-regulasi" class="form-horizontal" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 validate">
                                            <select name="tipe" class="form-control">
                                                <option value="{{ $regulasi->tipe_peraturan }}">{{ $regulasi->tipe_peraturan }}</option>
                                                <option>SE</option>
                                                <option>SK</option>
                                                <option>KM</option>
                                                <option>PM</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 validate">
                                            <input type="text" value="{{ $regulasi->nomor_peraturan }}" name="nomor_peraturan" class="form-control" id="" placeholder="Nomor Peraturan ...">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="form-field-1">
                                        ...
                                        <div class="col-sm-9 validate">
                                            <textarea class="form-control" name="tentang" cols="10" rows="3">{{ $regulasi->tentang }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="form-field-1">
                                        ...
                                        <div class="col-sm-9 validate">
                                            ...
                                            <span class="label-gmbr" style="margin-left: 2%;">{{ $regulasi->file }}</span> 
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-2">

        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form enctype="multipart/form-data" id="form-berita" action="{{ route('admin.publikasi.berita.store') }}" method="POST" class="form-horizontal">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="tabbable">
                                        ...
                                        <div class="tab-pane active" id="panel_tab3_example1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9 validate">
                                                    <input type="text" name="judul_id" placeholder="Judul"
                                                        class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea name="deskripsi_id" class="ckeditor form-control"
                                                        cols="10" rows="10" id="editor1"></textarea>
                                                </div>
                                            </div>
                            ...
                            <div class="col-sm-12">
                                <div style="margin-left: 20px;margin-right: 20px">
                                    <div class="form-group validate">
                                        <label class="control-label">
                                            Tanggal
                                                ...
                                                <input placeholder="Tanggal ..." type="text" name="tanggal"
                                    ...
                                    <div class="form-group validate">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="videosource" value="image">
                                            Gambar
                                        </label>
                                    </div>

                                    <div class="form-group validate" id="elemen">
                                        <input type="text" required name="url_youtube" placeholder="Url Youtube" class="form-control">
                                    </div>
                                </div>

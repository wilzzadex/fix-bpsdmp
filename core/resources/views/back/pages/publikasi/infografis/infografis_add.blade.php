        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{ route('admin.publikasi.infografis.store') }}" id="form-info" class="form-horizontal" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-12 ">
                                <div class="tabbable">
                                            ...
                                            <p>
                                                <div class="form-group validate">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="text" name="judul_id" placeholder="Judul" id="form-field-1" class="form-control">
                                                    </div>
                                                </div>
                                            </p>
                                        </div>
                                        ...
                                        <p>
                                                <div class="form-group validate">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="text" name="judul_en" placeholder="Infographic Title" id="form-field-1" class="form-control">
                                                    </div>
                                                </div>
                                            </p>
                                        </div>

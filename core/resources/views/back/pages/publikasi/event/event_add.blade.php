        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{ route('admin.publikasi.event.store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal" id="form-event">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="tabbable">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9 validate">
                                                        <input type="text" placeholder="Judul"
                                                            class="form-control" name="judul_id">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">
                                                    ...
                                                    <div class="col-sm-9 validate" >
                                                        <textarea class="ckeditor form-control" cols="10"
                                                            rows="10" name="deskripsi_id"></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9 validate">
                                                        <input type="text" placeholder="Title"
                                                            class="form-control" name="judul_en">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">
                                                    ...
                                                    <div class="col-sm-9 validate">
                                                        <textarea class="ckeditor form-control" cols="10"
                                                            rows="10" name="deskripsi_en">-</textarea>
                                                    </div>
                                                </div>        
                                            </p>
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 validate">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="tanggal" class="form-control date-time-range">
                                    </div>
                                </div>
                            </div>
                            <br>

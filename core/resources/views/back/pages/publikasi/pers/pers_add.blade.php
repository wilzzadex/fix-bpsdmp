        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{ route('admin.publikasi.pers.store') }}" id="form-pers" method="POST" class="form-horizontal"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                        ...
                                        <div class="tab-pane" id="panel_tab3_example2">
                                            ...
                                            <div class="form-group validate">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" name="judul_en" placeholder=" Title"
                                                        class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group validate">
                                ...
                                <div class="form-group validate" style="margin-left: 20px;margin-right:20px">
                                ...
                                <div class="form-group" style="margin-left: 20px;margin-right:20px">
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" name="videosource" value="gambar">
                                        Gambar
                                    </label>
                                ...
                                <div class="form-group validate" style="margin-left: 20px;margin-right:20px" id="elemen">
                                    <input type="url" required name="url_youtube" placeholder="Url Youtube" class="form-control">
                                </div>

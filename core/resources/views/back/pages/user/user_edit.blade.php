        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{ route('admin.user.update',$users->id) }}" id="form-slider" method="POST">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="form-group validate">
                                        ...
                                        <input type="text" name="nama" value="{{ $users->name }}" placeholder="Nama User ..."
                                            class="form-control">
                                    ...
                                    <div class="form-group validate">
                                        ...
                                        <input type="text" value="{{ $users->username }}" placeholder="Username ..." name="username"
                                            class="form-control">

        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{ route('admin.popup.update',$popup->id) }}" id="form-popup" enctype="multipart/form-data" method="POST">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group validate">   
                                    <label for="">Nama File</label>
                                    <input type="text" value="{{ $popup->nama_file }}" name="nama_file" placeholder="Nama File ..." class="form-control">
                                </div>
                                <br>
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        ...
                                        <span class="label-gmbr" style="margin-left: 2%;"><a href="javascript:void(0);" onclick="lihat_gmbr(this)" data-toggle="modal" data-target="#detil" data-gmbr="{{ asset('file_app/popup_image/'.$popup->file) }}">{{ $popup->file }}</a></span> 
        ...
        function hasilgmbr(obj) {
            ...
            if (obj.files && obj.files[0] && (ext == "png" || ext == "jpeg" || ext == "jpg")) {
                if(obj.files[0].size > 5242880){
                    ...
                    $('.label-gmbr').html(`<a href="javascript:void(0);" onclick="lihat_gmbr(this)" data-toggle="modal" data-target="#detil" data-gmbr="{{ asset('file_app/popup_image/'.$popup->file) }}">{{ $popup->file }}</a>`);
                    $("#inputFile").val('');
                }else{

        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{ route('admin.slider.post') }}" method="POST" id="form-slider" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="tabbable">
                                            ...
                                            <p>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-12 validate">
                                                            ...
                                                            <input  type="text" placeholder="Judul" class="form-control" name="judul_id">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-horizontal">
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="text" placeholder="Slider Title" class="form-control" name="judul_en">
                                                    </div>
                                                </div>
                                            </div>
                                            </p>
...
<script>
    ...
    var image = '{{ asset("gif/loader.gif") }}'
    ...
    function hasilgmbr(obj) {
            ...
            if (obj.files && obj.files[0] && (ext == "png" || ext == "jpeg" || ext == "jpg")) {
                if(obj.files[0].size > 5242880){
                    ...
                    $('.label-gmbr').html('Belum ada gambar');
                    $("#inputFile").val('');
                }else{
